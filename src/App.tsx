  ...
  const projects = [
    {
      ...
      image: 'https://images.unsplash.com/photo-1566915896913-549d796d2166?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkZXZlbG9wZXIlMjB3b3Jrc3BhY2UlMjBjb2Rpbmd8ZW58MXx8fHwxNzYyNzI5NzMyfDA&ixlib=rb-4.1.0&q=80&w=1080',
      category: 'Full-stack',
      liveLink: '#',
      githubLink: '#',
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1609921212029-bb5a28e60960?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2JpbGUlMjBhcHAlMjBkZXNpZ258ZW58MXx8fHwxNzYyNjg2MDU2fDA&ixlib=rb-4.1.0&q=80&w=1080',
      category: 'Web',
      liveLink: '#',
      githubLink: '#',
    },
    {
      ...
      description: 'Monitoring and analytics dashboard for managing microservices infrastructure.',
      tech: ['Vue.js', 'Python', 'Docker', 'Kubernetes'],
      image: 'https://images.unsplash.com/photo-1546900703-cf06143d1239?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3ZWIlMjBkZXZlbG9wbWVudCUyMGNvZGV8ZW58MXx8fHwxNzYyNjgzMTQ3fDA&ixlib=rb-4.1.0&q=80&w=1080',
      category: 'Backend',
      liveLink: '#',
      githubLink: '#',
    },
    {
      ...
      description: 'Automated cloud migration platform for seamless transition to AWS infrastructure.',
      tech: ['Go', 'AWS', 'Terraform', 'Redis'],
      image: 'https://images.unsplash.com/photo-1759752394755-1241472b589d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjbG91ZCUyMGluZnJhc3RydWN0dXJlJTIwdGVjaG5vbG9neXxlbnwxfHx8fDE3NjI2NjgwNTh8MA&ixlib=rb-4.1.0&q=80&w=1080',
      category: 'Backend',
      liveLink: '#',
      githubLink: '#',
    },
          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                ...
                Specializing in full-stack development, cloud architecture, and DevOps practices.
              </motion.p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <p className="text-[#9ca3af] leading-relaxed">
                ...
                web applications, mobile apps, and cloud-based solutions. I specialize in creating
                scalable, maintainable, and user-friendly applications using modern technologies.
              </p>
              <p className="text-[#9ca3af] leading-relaxed">
                My expertise spans across frontend frameworks like React and Vue.js, backend
                technologies including Node.js and Go, and cloud infrastructure with AWS and
                Kubernetes. I'm committed to writing clean code and following best practices.
              </p>
              ...
              <div className="space-y-4 pt-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-[#f5f5f7] mb-1">Senior Full-Stack Developer</h4>
                    <p className="text-[#9ca3af]">TechCorp Inc. • 2021 - Present</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-[#06b6d4] rounded-full mt-2" />
                  <div>
                    <h4 className="text-[#f5f5f7] mb-1">Full-Stack Developer</h4>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-[#f5f5f7] mb-1">B.S. Computer Science</h4>
                    <p className="text-[#9ca3af]">University of Technology • 2015 - 2019</p>
                  </div>
                </div>
              </div>
            ...
            >
              ...
              <div className="bg-[rgba(20,20,30,0.7)] backdrop-blur-sm border border-[rgba(100,100,120,0.2)] rounded-2xl p-6">
                ...
                <div className="flex flex-wrap gap-3">
                  {['Git', 'GitHub Actions', 'Jenkins', 'AWS', 'GCP', 'MongoDB', 'Redis', 'Nginx'].map((tool) => (
                    <span
                      key={tool}
